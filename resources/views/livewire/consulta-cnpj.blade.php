<div class="max-w-4xl mx-auto p-6">
    ...
    <div class="bg-white p-6 rounded-lg shadow-md">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            ...
            <div>
                <label for="api" class="block text-sm font-medium text-gray-700 mb-1">
                    API
                </label>
                <select 
                    id="api" 
                    wire:model="apiSelecionada"
                    class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
                >
                    <option value="ambos">Ambas (fallback)</option>
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-green-700">
                            Dados obtidos via <strong>{{ $result['origem'] }}</strong>
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <dl class="sm:divide-y sm:divide-gray-200">
                        ...
                        @foreach($result['dados']['socios'] as $socio)
                            <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 bg-gray-50">
                                ...
                                <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                                    CPF/CNPJ: {{ $socio['cnpj_cpf'] ?? $socio['cpf'] ?? 'N/A' }}
                                    <br>
